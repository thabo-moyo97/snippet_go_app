...
func (rh *RouteHandler) SnippetRoutes(protected, dynamic alice.Chain) http.Handler {
	...
	mux.Handle("GET /snippet/view/{id}", protected.ThenFunc(snippetHandler.SnippetView))
	mux.Handle("GET /snippet/edit/{id}", protected.ThenFunc(snippetHandler.SnippetEditView))
